...
//             // Our browser has a history object, when we navigate to different pages
//             // Because this is a single page app, we need to keep track of where we are
//             // History allows us to handle this navigation like a normal website
//             // This CLOSES the form and returns us to the previous page. It's like
//             // Us clicking the animals button link and returning to the /animals page.
//             .then(() => history.push("/animals"))
//         }
//     }
